...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            @can('role_create')
            <a href="{{ route('roles.create') }}" class="btn btn-primary px-3 mb-2">
                <b>{{ __('Tambah') }}</b>
            </a>
            @endcan
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover table-sm" id="roles">
                        <thead>
                        <tr>
                            <th>{{ __('ID.') }}</th>
                            <th>{{ __('Nama') }}</th>
            ...
            const reloadDeleteModal = () => {
                ...
                deleteBtn.forEach( el => {
                    el.addEventListener('click', e => {
                        ...
                        form += '<div class="alert alert-info">{{ __("Hapus role ini? Proses ini tidak bisa dibatalkan.") }}</div>';
                        form += '</div>';
